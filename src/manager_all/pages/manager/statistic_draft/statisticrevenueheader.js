...
import StatisticRevenueSearchDate from './statisticrevenuesearchdate.js'

export default function StatisticRevenueHeader (props) {
    const {setFromTo} = props

    return (
    		<div className="statistic--order">
				<h3>Thống kê theo doanh thu</h3>
        		<StatisticRevenueSearchDate setFromTo={setFromTo}/>
    		</div>
    )
}
/*
