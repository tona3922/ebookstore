            ...
            <form className="card-form" onChange={this.handleChange}>
                ...
                <div className="multi-inputs">
                    <div className="form--input" style={{ "width": "75%" }}>
                        <input type="text" className="input-field" value={this.state.title} required />
                ...
                <div className="multi-inputs">
                    <div className="form--input" style={{ "width": "75%" }}>
                        <input type="text" className="input-field" value={this.state.author_name} onChange={this.handleChange} required />
