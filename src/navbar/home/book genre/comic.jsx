    ...
    <div>
      <div className="genretitle">
        ...
        <div className="centertitle">
          <div className="titlegenre">Comic</div>
        </div>
        <div className="covertitle">
      ...
      <button class="sort_category">
        <select onChange={(event) => handleChange(event.target.value)}>
          ...
          <option value="Htlcomic">Highest to lowest</option>
          <option value="Lthcomic">Lowest to highest</option>
        </select>
      </button>
      {(() => {
        if (final.length === 0) {
